        ...
        var Gallery = {
            ...
            updatePreview : function (direction) {
                var transition = function () {
                    ...
                    Gallery.imgView.css({"marginLeft" : "0" , "marginRight" : "0", "opacity" : "1"});
                    Gallery.imgView.attr("src" , "images/" + Gallery.imageBank[Gallery.imgIndex]);
                };

                if (direction == "left") {
                    Gallery.imgView.animate({"marginLeft" : "-100%" , "opacity" : "0"}, transition);
                } else {
                    Gallery.imgView.animate({"marginRight" : "-100%", "opacity" : "0"}, transition);
                }           
